...
const {loadGLTFIntoXKTModel, writeXKTModelToArrayBuffer} = require("@xeokit/xeokit-xkt-utils/dist/xeokit-xkt-utils.cjs.js");
...
module.exports = {
    ...
    convert: function convert(gltfContent, getAttachment) {
        ...
        const xktModel = loadGLTFIntoXKTModel(gltf, getAttachment);
