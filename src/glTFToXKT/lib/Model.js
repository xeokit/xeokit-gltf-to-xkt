...
import {createPositionsDecodeMatrix, quantizePositions, transformAndOctEncodeNormals} from "./geometryCompression.js";
...
class Model {
    ...
    finalize() {
        ...
        for (let i = 0, len = this.meshes.length; i < len; i++) {
            ...
            quantizePositions(mesh.positions, mesh.positions.length, aabb, quantizedPositions);
            ...
            transformAndOctEncodeNormals(modelNormalMatrix, mesh.normals, mesh.normals.length, encodedNormals, 0);
            mesh.normals = encodedNormals;
        }

        createPositionsDecodeMatrix(aabb, this.positionsDecodeMatrix);
    }
}
