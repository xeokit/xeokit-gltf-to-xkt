...
function getModelData(model) {
    ...
    const primitiveReuseFactor = numPrimitives / numEntities;

    console.log("[XKT 4] Num positions                  = " + data.positions.length / 3);
    console.log("[XKT 4] Num triangles                  = " + data.indices.length / 3);
    console.log("[XKT 4] Num primitives                 = " + numPrimitives);
    console.log("[XKT 4] Num entities                   = " + numEntities);
    console.log("[XKT 4] Num matrices                   = " + countEntityMatrices);
    console.log("[XKT 4] Primitive/entity reuse ratio   = 1:" + primitiveReuseFactor);
    console.log("[XKT 4] Num quantize partitions        = " + (model.decodeMatrices.length / 16));
